...
Plataforma de streaming de vídeo minimalista desenvolvida com **Vue.js 3** e **Tailwind CSS v4**, focada em performance, tipagem rigorosa e interface de usuário refinada.
